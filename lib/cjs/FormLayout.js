...
var FormLayout = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "nice-form-layout", style: style }, { children: elements.map(function (_a) {
            ...
            return ((0, jsx_runtime_1.jsxs)("div", __assign({ style: fieldStyle }, { children: [element, field.extraNode || null] }), field.key));
        }) })));
};
