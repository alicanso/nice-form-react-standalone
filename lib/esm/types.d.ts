...
export type FieldMetaConverter = ({ meta, field, }: {
    meta: NiceFormMeta;
    field: NiceFormField;
}) => NiceFormField;
/**
...
export interface NiceFormField extends Record<string, unknown> {
     ...
     * @returns
     */
    renderView?: (value: any, { field, meta }: {
        field: NiceFormField;
        meta: NiceFormMeta;
    }) => ReactElement | null;
    /**
...
export interface NiceFormAdapter {
     ...
     * @returns
     */
    renderField?: ({ meta, field, }: {
        meta: NiceFormMeta;
        field: NormalizedFormField;
    }) => React.ReactElement | null;
    renderFieldWithoutLabel?: ({ meta, field, }: {
        meta: NiceFormMeta;
        field: NormalizedFormField;
    }) => React.ReactElement | null;
    /**
...
export interface NiceFormConfig {
     ...
     * @returns
     */
    defineWidget: (name: string, widget: ReactComponent, metaConverter?: ({ meta, field }: {
        meta: NiceFormMeta;
        field: NiceFormField;
    }) => NiceFormField) => void;
    /**
